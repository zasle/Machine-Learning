...
#定义文本框和箭头格式
decisionNode = dict(boxstyle="square",fc="#FFFF00",ec="#FFCC00")
leafNode = dict(boxstyle="round4",fc="#33CCCC",ec="#006633")

arrow_args = dict(arrowstyle="<-",ec="#BA4A00")
...
def plotMidText(cntrPt, parentPt, txtString):
	...
	createPlot.ax1.text(xMid, yMid, txtString, va="bottom", ha="center", rotation=0)
